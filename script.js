...
function promptUser() {
  pwLength = prompt("How many characters do you want in your password? Enter a number between 12 and 128.","");
  pwLength = Number(pwLength);
  console.log(pwLength);
  
  if((pwLength < 12) || (pwLength > 128)) {
    alert("You must enter a number between 12 and 128.");
    return promptUser();
  }
